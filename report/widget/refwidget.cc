...
QTableView* RefWidget::View() const { return ui->tableView; }

QAbstractItemModel* RefWidget::Model() const { return ui->tableView->model(); }
...
void RefWidget::on_pBtnRefresh_clicked() { emit SResetModel(node_id_, start_.toUTC(), end_.toUTC()); }
