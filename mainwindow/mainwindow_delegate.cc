...
void MainWindow::TableDelegateI(QTableView* table_view, TreeModel* tree_model, CSectionConfig& config, const QUuid& node_id) const
{
    ...
    QSortFilterProxyModel* filter_model { tree_model->ExcludeMultipleModel(node_id, std::to_underlying(NodeUnit::IExternal), table_view) };
...
void MainWindow::TableDelegateP(QTableView* table_view, CSectionConfig& config) const
{
    ...
    auto* ext_filter_model { tree_model_i->IncludeUnitModel(std::to_underlying(NodeUnit::IExternal), table_view) };
    ...
    auto* int_filter_model { tree_model_i->IncludeUnitModel(std::to_underlying(NodeUnit::IInternal), table_view) };
...
void MainWindow::DelegateSettlement(QTableView* table_view, CSectionConfig& config) const
{
    ...
    const int unit { start_ == Section::kSale ? std::to_underlying(NodeUnit::PCustomer) : std::to_underlying(NodeUnit::PVendor) };
