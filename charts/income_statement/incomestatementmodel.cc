...
void Model::Rebuild(const QJsonArray& node_array, const QJsonArray& path_array, double net_profit, double yoy_net_profit, double mom_net_profit)
{
...

    {
        ...
        path::AttachRootNodes(node_hash_, net_profit_);
