...
void Preferences::InitData()
{
    ...
    if (is_enable_status_) {
        ...
        path_model_->AppendItem(QUuid(), QString());
    ...
    ui->spinRateDecimal->setMaximum(numeric_const::kDecimalPlaces8);
    ui->spinQuantityDecimal->setMaximum(numeric_const::kDecimalPlaces8);
...
void Preferences::InitStringList()
{
    ...
    date_format_list_.emplaceBack(datetime_format::kDashedDate);
}
